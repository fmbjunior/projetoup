Public Class FolhaPgtoFeriasGerarLancamento
...
#Region "Gerações de Pagamentos"
    ...
    Private Sub GeraFerias()
        ...
        Sql = "Select * from FolhaPgtoFerias where Funcionario = " & My.Forms.FolhaPgtoFeriasVisualizador.Funcionario.Text & " And Pago='PMR'  And Empresa = " & CodEmpresa
        Dim DaValidar As New OleDb.OleDbDataAdapter(Sql, CNN)
        DaValidar.Fill(DS, "Validar")
        Dim TotalValidar As Integer = DS.Tables("Validar").Rows.Count
        If TotalValidar = 0 Then
        ...
        Sql = "SELECT FolhaPgtoFerias.*, FolhaPgtoFerias.Funcionario, Funcionários.Nome, Funcionários.TipoPagamentoMensal, FolhaPgtoFerias.Pago, FolhaPgtoFerias.Funcionario, Funcionários.CodPlanoContas FROM Funcionários INNER JOIN FolhaPgtoFerias ON Funcionários.CódigoFuncionário = FolhaPgtoFerias.Funcionario WHERE (((FolhaPgtoFerias.Funcionario)=" & My.Forms.FolhaPgtoFeriasVisualizador.Funcionario.Text & ") AND ((FolhaPgtoFerias.Pago)='PMR') AND ((FolhaPgtoFerias.Empresa)=" & CodEmpresa & ")) ORDER BY Funcionários.Nome"
        ...
        For Each DrPagamento In DS.Tables("Pagamentos").Rows
            ...
            If CDbl(NzVlr(DrPagamento("ValorFerias"))) > 0 Then
                ...
                'IIDD = IIDD & DrPagamento("FolhaPgtoFerias.Funcionario")
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@2", Me.DataLançamento.Text))
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@3", 4010201000005)) ' conta das Férias
                ...
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@4", 4010201000005)) ' conta das Férias
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@5", IIDD))
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@6", Me.DataLançamento.Text))
                ...
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@2", Me.DataLançamento.Text))
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@3", DrPagamento("CodPlanoContas"))) ' conta do Funcionario
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@4", 2020302000003))      ' Contga do Inss
                ...
                'IIDD = IIDD & DrPagamento("FolhaPgtoFerias.Funcionario")
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@2", Me.DataLançamento.Text))
                Cmd.Parameters.Add(New OleDb.OleDbParameter("@3", 2020302000003))      ' Contga do Inss
        ...
        myCommand = New OleDb.OleDbCommand("UPDATE FolhaPgtoFerias SET FolhaPgtoFerias.Pago = 'SIM' WHERE FolhaPgtoFerias.Funcionario=" & My.Forms.FolhaPgtoFeriasVisualizador.Funcionario.Text & " AND FolhaPgtoFerias.Empresa=" & CodEmpresa & " And FolhaPgtoFerias.Pago='PMR'", CNN)
        Try
