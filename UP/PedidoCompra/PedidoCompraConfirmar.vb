...
Public Class PedidoCompraConfirmar
    ...
    Private Sub ExcluirTodasAsParcelasToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExcluirTodasAsParcelasToolStripMenuItem.Click
        ...
        If ListaPagar.RowCount > 0 Then
            ...
            Dim Sql As String
            Sql = "Delete * from Pagar where IDPedidoCompra=" & My.Forms.SellShoesPedidoCompra.CodigoPedidoCompra.Text
    ...
    Private Sub PedidoCompraConfirmar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.tValorPedidoCompra.Text = My.Forms.SellShoesPedidoCompra.TotalItensLançado.Text
        Me.txtDataLancamento.Text = My.Forms.SellShoesPedidoCompra.txtDataLancamento.Text
    End Sub
    Sub CreateCol()
    ...
    Private Sub EncheGrid()
        ...
        Dim Sql As String = "SELECT *  FROM Pagar Where IdPedidoCompra=" & My.Forms.SellShoesPedidoCompra.CodigoPedidoCompra.Text
...
#End Region
    ...
    Private Sub btFindValor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btFindValor.Click
        My.Forms.ResultadosContasProcura.ShowDialog()
        AchaContaCR(Me.ContaLancamento.Text, Me.ContaLancamentoDesc)
        Me.ContaLancamento.Focus()
    End Sub
    ...
    Private Sub butConfirmar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butConfirmar.Click
        ...
        If ListaPagar.RowCount > 0 Then
            ...
            Try
                ...
                Next rowIndex
                myTrans.Commit()
                My.Forms.SellShoesPedidoCompra.RetornaFechamento = True
                Me.Close()
                Me.Dispose()
            Catch ex As Exception
                MsgBox(ex.Message)
    ...
    Private Sub btnGerarParcelas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGerarParcelas.Click
        ...
        vValorParcelado = CDbl(Me.tValorPedidoCompra.Text) / Me.parcelas.Text
        Dim I As Integer = 0
        For I = 1 To Me.parcelas.Text
            ...
            DRnovo = TBL.NewRow()
            DRnovo("Documento") = My.Forms.SellShoesPedidoCompra.CodigoPedidoCompra.Text & "PC-" & I
            DRnovo("CodFornecedor") = Nz(My.Forms.SellShoesPedidoCompra.txtCodigoFornecedor.Text, 1)
            DRnovo("Fornecedor") = Nz(My.Forms.SellShoesPedidoCompra.txtRazaoSocial.Text, 1)
            ...
            DRnovo("IdPedidoCompra") = Nz(SellShoesPedidoCompra.CodigoPedidoCompra.Text, 1)
